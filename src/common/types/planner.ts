export type PlannerEntryStatus = 'planned' | 'queued' | 'working' | 'done' | 'blocked' | 'skipped';

export type PlannerIssuePriority = 'none' | 'low' | 'medium' | 'high' | 'urgent';
export type PlannerAssigneeType = 'member' | 'agent' | 'squad';
...
export interface PlannerEntry {
  ...
  priority: PlannerIssuePriority;
  position: number;
  project_id: string | null;
  goal_id: string | null;
  issue_id: string | null;
  assignee_type: PlannerAssigneeType | null;
