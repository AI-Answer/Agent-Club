 ...
 *   - macOS:   ~/Library/Logs/Agent Club/YYYY-MM-DD.log
 *   - Windows: %USERPROFILE%\AppData\Roaming\Agent Club\logs\YYYY-MM-DD.log
 *   - Linux:   ~/.config/Agent Club/logs/YYYY-MM-DD.log
 *
