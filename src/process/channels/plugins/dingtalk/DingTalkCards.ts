...
export function createMainMenuCard(): DingTalkCard {
  return {
    title: 'Agent Club Assistant',
    text: '### Agent Club Assistant\n\nWelcome! Choose an action below:',
    btnOrientation: '1',
    btns: [
...
export function createPairingCard(pairingCode: string): DingTalkCard {
  return {
    ...
    text: [
      '### Pairing Required',
      '',
      'Please pair your account with Agent Club:',
      '',
      `**Pairing Code:** \`${pairingCode}\``,
      '',
      '1. Open Agent Club settings',
...
export function createPairingStatusCard(pairingCode: string): DingTalkCard {
  return {
    ...
    text: [
      ...
      `**Pairing Code:** \`${pairingCode}\``,
      '',
      'Please approve in Agent Club settings:',
...
export function createHelpCard(): DingTalkCard {
  return {
    title: 'Agent Club Assistant Help',
    text: [
      '### Agent Club Assistant Help',
      '',
      'A remote assistant to interact with Agent Club via DingTalk.',
      '',
      '**Common Actions:**',
...
export function createPairingGuideCard(): DingTalkCard {
  return {
    ...
    text: [
      ...
      '3. Approve pairing in Agent Club settings',
