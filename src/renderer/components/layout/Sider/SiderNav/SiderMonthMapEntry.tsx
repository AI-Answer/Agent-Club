...
interface SiderMonthMapEntryProps {
  isMobile: boolean;
  isActive: boolean;
  collapsed: boolean;
...
const label = 'Month Map';

const SiderMonthMapEntry: React.FC<SiderMonthMapEntryProps> = ({
  isMobile,
  isActive,
  collapsed,
  siderTooltipProps,
    ...
    return (
      <Tooltip {...siderTooltipProps} content={label} position='right'>
        <div
          ...
          onClick={onClick}
        >
          <Calendar theme='outline' size='20' fill='currentColor' className='block leading-none shrink-0' />
        </div>
      </Tooltip>
    );
  }
    ...
    <Tooltip {...siderTooltipProps} content={label} position='right'>
      ...
      >
        <span className='w-28px h-28px flex items-center justify-center shrink-0'>
          <Calendar theme='outline' size='20' fill='currentColor' className='block leading-none' />
        </span>
...
export default SiderMonthMapEntry;
