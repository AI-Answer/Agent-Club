...
import { Earth, Youtube } from '@icon-park/react';
    ...
    >
      <div className='flex justify-center items-center gap-24px'>
        ...
        <div
          ...
          onMouseLeave={() => setHoveredQuickAction(null)}
          onClick={() => onOpenLink('https://www.youtube.com/@SaminYasar_?sub_confirmation=1')}
        >
          <Youtube
            theme='filled'
            size={20}
            fill='currentColor'
            className='flex-shrink-0 text-[var(--color-text-3)] group-hover:text-[#FF0033] transition-colors duration-300'
          />
