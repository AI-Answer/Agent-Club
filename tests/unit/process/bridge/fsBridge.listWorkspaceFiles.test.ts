...
vi.mock('@/common', () => ({
  ipcBridge: {
    fs: {
      ...
      searchJourneyKits: makeProvider('searchJourneyKits'),
      installJourneyKit: makeProvider('installJourneyKit'),
      getJourneyKitsConfig: makeProvider('getJourneyKitsConfig'),
      saveJourneyKitsConfig: makeProvider('saveJourneyKitsConfig'),
      listJourneyKitsOwned: makeProvider('listJourneyKitsOwned'),
      publishJourneyKitSkill: makeProvider('publishJourneyKitSkill'),
      deleteJourneyKitOwned: makeProvider('deleteJourneyKitOwned'),
    },
