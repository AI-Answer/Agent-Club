...
vi.mock('@/common', () => ({
  ipcBridge: {
    fs: {
      ...
      searchJourneyKits: { provider: vi.fn() },
      installJourneyKit: { provider: vi.fn() },
      getJourneyKitsConfig: { provider: vi.fn() },
      saveJourneyKitsConfig: { provider: vi.fn() },
      listJourneyKitsOwned: { provider: vi.fn() },
      publishJourneyKitSkill: { provider: vi.fn() },
      deleteJourneyKitOwned: { provider: vi.fn() },
    },
